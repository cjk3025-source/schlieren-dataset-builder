        ...
        if dataset_df.empty:
            ...
            with fume_tab:
                ...
                if matched_fume_frame is not None and matched_fume_frame.exists():
                    ...
                    if not render_video_blob(review_fume_video, "Fume video"):
                        st.info("Fume 영상을 미리보기로 불러오지 못했습니다.")
            ...
            with spatter_tab:
                ...
                if matched_spatter_frame is not None and matched_spatter_frame.exists():
                    ...
                    if not render_video_blob(review_spatter_video, "Spatter video"):
                        st.info("Spatter 영상을 미리보기로 불러오지 못했습니다.")
